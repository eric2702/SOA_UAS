...
<style>
    ...
    .form-control.modal-edit::-webkit-calendar-picker-indicator {
        filter: invert(0);
    }
    ...
    <section style="min-height: 100vh;" class="background overflow-hidden">
        ...
        <section class="help mt-5" id="help">
            <div class="decoration text-center">
                <h6 class="d-none d-sm-block d-sm-none d-md-block">Make your Order now! - <i class="fas fa-glass-cheers"></i> Make your Order now! - <i class="fas fa-glass-cheers"></i> Make
                    your Order now! - <i class="fas fa-glass-cheers"></i> Make your Order now! - <i class="fas fa-glass-cheers"></i> Make your Order now! - <i class="fas fa-glass-cheers"></i> Make
            ...
            <div class="decoration text-center">
                <h6>Make your Order now! - <i class="fas fa-glass-cheers"></i> Make your Order now! - <i class="fas fa-glass-cheers"></i> Make your Order now! - <i class="fas fa-glass-cheers"></i> Make
                    your Order now! - <i class="fas fa-glass-cheers"></i> Make your Order now! - <i class="fas fa-glass-cheers"></i> Make your Order now! - <i class="fas fa-glass-cheers"></i></h6>
            </div>
        </section>
