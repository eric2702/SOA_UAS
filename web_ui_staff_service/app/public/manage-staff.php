            ...
            <div class="collapse" id="collapseExample">
                <div class="row form-add-staff">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="add-staff-name" class="form-control input-staff" name="description"
                            required>
                    </div>

                    <div class="mb-3">
                        <label for="description" class="form-label modal-edit">Email:</label>
                        <input type="text" id="add-staff-email" class="form-control input-staff" name="description"
                            required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" id="add-staff-password" class="form-control input-staff"
                ...
                <div class="modal-body">
                    ...
                    <form id="clientForm" class="">
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control modal-edit" id="staff-email"
