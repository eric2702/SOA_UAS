    ...
    <div class="container-fluid text-center">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active real" aria-current="page" href="client.php">Clients</a>
                </li>
                <li class="nav-item d-none d-sm-block">
                    <a class="nav-link active decor" aria-current="page" href="#">|</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active real" aria-current="page" href="manage-staff.php">Manage Staffs</a>
                </li>
                <li class="nav-item d-none d-sm-block">
                    <a class="nav-link active decor" aria-current="page" href="#">|</a>
                </li>
