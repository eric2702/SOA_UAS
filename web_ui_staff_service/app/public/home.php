...
<body>
    ...
    <section style="min-height: 100vh;" class="background-radial-gradient overflow-hidden">
        ...
        <div class="container">
            <<<<<<< HEAD=======<div align="center" style="margin-top:40px;">
    ...
    <<<<<<< HEAD <div class="modal fade" id="eventsModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                ...
                $(document).ready(function() {
                    ...
                    $(document).on('click', '.expand-details', function() {
                        ...
                        if (row.hasClass('shown')) {
                            ...
                            row.after('<tr class="details-row"><td colspan="3">' + format(order) +
                                '</td></tr>');
                            row.addClass('shown');
                        }
                    });
                            ...
                            success: function(response) {
                                if (response.success) {
                                    ...
                                    for (var i = 0; i < orderDetails.length; i++) {
                                        ...
                                        leftColumn.append('<p>Location: ' + detail.location +
                                            '</p>');
                                        ...
                                        rightColumn.append('<p>Time Start: ' + detail
                                            .time_start + '</p>');
                                        rightColumn.append('<p>Time End: ' + detail.time_end +
                                            '</p>');
