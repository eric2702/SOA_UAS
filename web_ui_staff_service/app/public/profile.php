    ...
    <section style="min-height: 100vh;" class="background-radial-gradient overflow-hidden">
        ...
        <div class="container bg-white p-5" style="margin-top:40px;">
            <div class="d-flex justify-content-end">
                <button type="button" class="btn btn-secondary ms-auto" data-bs-toggle="modal" data-bs-target="#change-passwd-modal">
        ...
        <script>
            $(document).ready(function() {
                ...
                var id_staff = sessionStorage.getItem('id');
                $.ajax({
                    url: 'http://localhost:8082/staff/' + id_staff,
                    method: 'GET',
                ...
                $('#change-passwd-submit').click(function() {
                    ...
                    $.ajax({
                        url: "http://localhost:8082/staff/password",
                        method: "PUT",
                        data: JSON.stringify(formData),
                        contentType: "application/json",
                        success: function(response) {
